...
class ConvBlock(nn.Module):
    ...
    def __init__(self, inplanes, outplanes, stride=1, res_conv=False, act_layer=nn.Tanh, groups=1,
...
class FCUUp(nn.Module):
    ...
    def __init__(self, inplanes, outplanes, up_stride, act_layer=nn.Tanh,
...
class Med_ConvBlock(nn.Module):
    ...
    """
    def __init__(self, inplanes, act_layer=nn.Tanh, groups=1, norm_layer=partial(nn.BatchNorm2d, eps=1e-6),
