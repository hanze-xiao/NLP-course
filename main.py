...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--model', default='Conformer_small_patch32', type=str, metavar='MODEL',
                        help='Name of model to train')
    parser.add_argument('--input-size', default=32, type=int, help='images input size')

    parser.add_argument('--drop', type=float, default=0.8, metavar='PCT',
    ...
    parser.add_argument('--warmup-lr', type=float, default=1e-1, metavar='LR',
    ...
    # Dataset parameters
    parser.add_argument('--data-path', default='C:/Users/11572/Desktop/NLP和深度学习大作业/图像/cifar100', type=str,
                        help='dataset path')
    parser.add_argument('--data-set', default='CIFAR', choices=['CIFAR', 'CIFAR10', 'IMNET', 'INAT', 'INAT19'],
...
def main(args):
    ...
    if args.resume:
        ...
        if 'model' in checkpoint.keys():
            ...
            model_without_ddp.load_state_dict(checkpoint,False)
    ...
    #.......
    epoch = np.arange(1, len(loss_list) + 1, 1)
